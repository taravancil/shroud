...
Shroud.prototype.add = async function (secretObj) {
  ...
  return await this.vault.add(secretName, sealedSecretObj, secretObj.category)
}

Shroud.prototype.remove = async function (secretName, category) {
  return await this.vault.remove(secretName, category)
}

Shroud.prototype.reveal = async function (secretName, category) {
  ...
  try {
    ...
    return String.fromCharCode.apply(null, decryptedSecret)
  } catch (err) {
    throw err
  }
}
